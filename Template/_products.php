        ...
        <div class="row">
            ...
            <div class="col-sm-6 py-5">
                ...
                <div id="order-details" class="font-rale d-flex flex-column text-dark">
                    ...
                    <small>Sold by <a href="#">ASJ Inverters </a>(4.5 out of 5 | 18,198 ratings)</small>
                ...
                <div class="size my-3">
                    ...
                    <div class="d-flex justify-content-between w-75">
                        <div class="font-rubik border p-2">
                            <button class="btn p-0 font-size-14">2.5-5 K</button>
                        </div>
                        <div class="font-rubik border p-2">
                            <button class="btn p-0 font-size-14">4-5 K</button>
                        </div>
                        <div class="font-rubik border p-2">
                            <button class="btn p-0 font-size-14">5-9 K</button>
                        </div>
                    </div>
                </div>
                <!-- !size -->
